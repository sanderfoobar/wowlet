...
ColumnLayout {
    ...
    MyText {
        ...
        Layout.fillWidth: true
        fontSize: 21
        text: "Shoutouts: matzman666, qvqc, ez, Gatto, RAGEHAÜZ, cisme, wowario, lza_menace, jwinterm, nioc, asymptotically, azy, selsta, kico, laura, thrmo, GNVR, solar, bl4sty, scoobybejesus, Valve Corporation for OpenVR"
        wrap: true
    }
